...
/*
    ...
    private fun initObserverData(viewModel: PokeDetailsViewModel, viewPager: ViewPager, tabsDetails: TabLayout) {
        viewModel.apply {
    ...
    private fun showDataEvolutionPoke(viewPager: ViewPager, tabs: TabLayout) {
        val sectionsPagerAdapterEvolution = fragmentManager?.let { fragmentManager ->
            PokeDetailsViewPagerAdapter(fragmentManager, pokemonId, 0)
        }
